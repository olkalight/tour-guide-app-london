...
public class AttrMusAdapter extends ArrayAdapter<Item> {

    // resource ID for the background color for this list of items
    private int mColorResourceId;

    public AttrMusAdapter(Activity context, ArrayList<Item> items, int colorResourceId) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    R.layout.attr_mus_layout, parent, false);
            // setup the holder
        ...
        // Get the Restaurant/Museum object located at this position in the list
        final Item currentItem = getItem(position);
        // Assign values if the object currentItem is not null
        if (currentItem != null) {
            // get the picture from the current Item object and set this picture on the ImageView
            ...
            // get the descriptionTextView from the current Item object and set this text on the TextView
            if (currentItem.hasDescription()) {
                holder.descriptionTextView.setText(currentItem.getAttractionDescription());
            }
